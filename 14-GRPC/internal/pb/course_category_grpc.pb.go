...
type CategoryServiceClient interface {
	...
	CreateCategoryBidirecional(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryBidirecionalClient, error)
...
func (c *categoryServiceClient) CreateCategoryBidirecional(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryBidirecionalClient, error) {
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], "/pb.CategoryService/CreateCategoryBidirecional", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceCreateCategoryBidirecionalClient{stream}
	return x, nil
}

type CategoryService_CreateCategoryBidirecionalClient interface {
	Send(*CreateCategoryRequest) error
	Recv() (*Category, error)
	grpc.ClientStream
}

type categoryServiceCreateCategoryBidirecionalClient struct {
	grpc.ClientStream
}

func (x *categoryServiceCreateCategoryBidirecionalClient) Send(m *CreateCategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryBidirecionalClient) Recv() (*Category, error) {
	m := new(Category)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type CategoryServiceServer interface {
	...
	CreateCategoryBidirecional(CategoryService_CreateCategoryBidirecionalServer) error
...
func (UnimplementedCategoryServiceServer) CreateCategoryBidirecional(CategoryService_CreateCategoryBidirecionalServer) error {
	return status.Errorf(codes.Unimplemented, "method CreateCategoryBidirecional not implemented")
}
...
func _CategoryService_CreateCategoryBidirecional_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoryBidirecional(&categoryServiceCreateCategoryBidirecionalServer{stream})
}

type CategoryService_CreateCategoryBidirecionalServer interface {
	Send(*Category) error
	Recv() (*CreateCategoryRequest, error)
	grpc.ServerStream
}

type categoryServiceCreateCategoryBidirecionalServer struct {
	grpc.ServerStream
}

func (x *categoryServiceCreateCategoryBidirecionalServer) Send(m *Category) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryBidirecionalServer) Recv() (*CreateCategoryRequest, error) {
	m := new(CreateCategoryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "CreateCategoryBidirecional",
			Handler:       _CategoryService_CreateCategoryBidirecional_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
